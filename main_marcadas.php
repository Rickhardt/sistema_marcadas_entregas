                        ...
                        <span aria-hidden="true">&times;</span>
                            ...
                            <div class="modal-body">
                                <form style="background: lightgray;">
                                    ...
                                    <!-- <div class="form-group">
                                <input type="checkbox" id="pg1" value="pagar_perm"> <label for="pg1">PAGAR PERMISO</label><br>
                                <input type="checkbox" id="pg2" value="pagar_sept"> <label for="pg2">PAGAR SEPTIMO</label>
                                </div> -->
                                    <div class="form-group">
                ...
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content bg-primary">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="TEXT" class="badge1" id="badge1" onKeyDown="if(event.keyCode==13) document.getElementById('act_cronos').click();">
                            ...
                            <form>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-info" onclick="filltabla()" id="act_cuadro">Reporte CRONOS Ver 2</button>
                    ...
                    <div id="divmodal">
                        ...
                        <span aria-hidden="true">&times;</span>
                            ...
                            <div class="form-group">
                                ...
                                <label for="observacion" class="col-form-label">Observacion:</label>
                                <select class="form-control" name="observacion2" id="observacion2" onchange="fechas_des()" required readonly>
                                    <option value="HORAS EXTRAS" class="bg-success"><b>HORAS EXTRAS</b></option>
                                </select>
                                <br>
                                <div id="rangos_extras"></div>
                                <!-- <label for="fechacons1" size="">F.Inicial:</label>&nbsp
                                        <input type="datetime-local" id="fechacons1" onchange="calcular_diff()"><br>
                                        <label for="fechacons2">F.Final:</label> &nbsp&nbsp
                                        <input type="datetime-local" id="fechacons2" onchange="calcular_diff()"> -->
                                <div>
                                    <br>
                                    <center>
                                        <label for="nhoras">No.de Horas:</label>
                                        <input type="text" id="nhoras" min="0" max="60" width="5px" size="17" disabled></center>

                                    <div class="form-group">

                                        <label for="message-text2" class="col-form-label">Notas:</label>
                                        <textarea class="form-control" id="message-text2" placeholder="(Opcional)"></textarea>



                                        <div name="tabla_notas3" id="tabla_notas3">
                                        </div>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal" id="cerrarmodal">Cerrar</button>
                                    <div id="svd2"><button type="button" class="btn btn-info" onclick="save_details_extras()" id="svd">Ingresar Hrs Extras</button></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function ajax_Tabla() {
        ...
        var d1 = new Date();
        var d2 = new Date(document.getElementById('inputSearch').value);
        // console.log(d1);
        // console.log(d2);
        ...
        if (d3 == true)  {
            swal.fire({
                title: "Error!",
                text: "LA FECHA INGRESADA ES MAYOR A LA ACTUAL",
        ...
        } else if  (document.getElementById('ent').checked == false && document.getElementById('sal').checked == false) {
            swal.fire({
                title: "Error!",
    ...
    function save_details_extras() {
        ...
        if (document.getElementById('area').value == '') {
            swal.fire({
                title: "Error",
                text: "OPERADOR NO TIENE UN AREA ASIGNADA!",
                showConfirmButton: true,
                icon: "error"
            })
        } else if (document.getElementById('nhoras').value == '') {
            swal.fire({
                title: "Error",
                text: "NO HAY HORAS EXTRAS A AGREGAR!",
                showConfirmButton: true,
                icon: "error"
            })
        } else if (document.getElementById('nhoras').value % 0.5 != 0) {
            swal.fire({
                title: "Error",
                text: "SOLO SE PERMITEN HORAS ENTERAS O MEDIAS HORAS!",
                showConfirmButton: true,
                icon: "error"
            })
            ...
            // console.log(sup);
            // console.log(todayf);
            // console.log(document.getElementById('fechacons11').value);
            // console.log(document.getElementById('fechacons22').value);
            // console.log(document.getElementById('Operadora1').value);
            // console.log(document.getElementById('Nombre').value);
            // console.log(document.getElementById('area').value);
            // console.log(document.getElementById('observacion2').value);
            // console.log(document.getElementById('message-text2').value);
            // console.log(document.getElementById('nhoras').value);
            // console.log(document.getElementById('tiempo1').value);
            // console.log(document.getElementById('tiempo2').value);
            // console.log(document.getElementById('turno').value);
            // console.log(estado_rad);
            // console.log(document.getElementById('ajuste').value);
            ...
            $.ajax({
                ...
                data: {
                    ...
                    sup: sup,
                    fecha: todayf,
                    fecha_s: document.getElementById('fechacons11').value,
                    fecha_s2: document.getElementById('fechacons22').value,
                    oper: document.getElementById('Operadora1').value,
                    nombre: document.getElementById('Nombre').value,
                    area: document.getElementById('area').value,
                    observacion: document.getElementById('observacion2').value,
                    notas: document.getElementById('message-text2').value,
                    nhoras: document.getElementById('nhoras').value,
                    horaini: document.getElementById('tiempo1').value,
                    horafin: document.getElementById('tiempo2').value,
                    turno: document.getElementById('turno').value,
                    tipo: estado_rad,
                    ajuste: document.getElementById('ajuste').value,
                    rol: document.getElementById('rol').value,
                    estado: 'SaveDetails_extras'
                },
                beforeSend: function() {
                ...
                success: function(r) {
                    ...
                    swal.fire({
                        title: "Exito!",
                        text: "Se agregaron Horas Extras para : " + document.getElementById('Operadora1').value,
                        showConfirmButton: false,
                        icon: "success",
                        timer: 5000
                    })
                    ...
                    $('input[id="nhoras"]').val('');
                    // $('input[id="message-text2"]').val('');
                    $('input[id="fechacons22"]').val('');
                    $('input[id="tiempo1"]').val('');
                    $('input[id="tiempo2"]').val('');

                    // $('input[id="cerrarmodal"]').click();
...
$.ajax({
    ...
    success: function(data) {
        var nameArr = JSON.parse(data);
        document.getElementById('message-text2').value = nameArr[0];
        document.getElementById('fechacons11').value = nameArr[1];
        document.getElementById('fechacons22').value = nameArr[2];
        document.getElementById('tiempo1').value = nameArr[3];
        document.getElementById('tiempo2').value = nameArr[4];
        document.getElementById('nhoras').value = nameArr[5];
    ...
    function fechas_des() {
        ...
        if (ob != '') {
            ...
            // if (document.getElementById('ajuste').value != 'SI') {
            if ((/INCAPACIDAD/i.test(ob)) != true && (/ENTRENAMIENTO/i.test(ob)) != true && (/PATERNIDAD/i.test(ob)) != true && (/SUSPENSION/i.test(ob)) != true && (/PERMISO PERSONAL/i.test(ob)) != true && (/CUARENTENA/i.test(ob)) != true && (/JORNADA/i.test(ob)) != true) {
                // document.getElementById('fechacons1').value = ''
                //document.getElementById('fechacons2').value = ''
                document.getElementById('fechacons1').disabled = true
                document.getElementById('fechacons2').disabled = true
    ...
    function calcular_diff2() {
        var fini = new Date($('#fechacons11').val() + " " + $('#tiempo1').val()).getTime();
        var ffin = new Date($('#fechacons22').val() + " " + $('#tiempo2').val()).getTime();
        ...
        $('input[id="nhoras"]').val(hrs);



        if (hrs <= 0 || Object.is(NaN, hrs)) {
            $("tiempo1").focus();
            $('input[id="nhoras"]').val('');
        }
    ...
    $('#exampleModal3').on('show.bs.modal', function(event) {
        ...
        var recipient51 = button.data('ajuste2')
        $('input[id="ajuste"]').val(recipient51)

        // modal.find('.modal-body input').val(recipient)
        $('input[id="Operadora1"]').val(recipient)


        var recipient2 = button.data('nombre2')
        $('input[id="Nombre"]').val(recipient2)

        var recipient3 = button.data('area2')
        $('input[id="area"]').val(recipient3)


        var recipient5 = button.data('turno2')
        $('input[id="turno"]').val(recipient5)
        ...
        modal.find('.modal-title').removeClass('bg-success')
        modal.find('.modal-title').addClass('bg-info')
        modal.find('turno').text(recipient5)
        modal.find('fechacons1').text(document.getElementById('inputSearch').value)

        var dd = document.getElementById('inputSearch').value

        $('#rangos_extras').html('<label for="fechacons1">F.Inicial:</label>&nbsp<input type="date" size="20px" id="fechacons11" disabled readonly value ="' + dd + '" min="' + dd + '" max="' + dd + '"> <input type="time" id="tiempo1" onblur="calcular_diff2()"><br><label for="fechacons2">F.Final:</label> &nbsp&nbsp<input type="date" size="20px" id="fechacons22" onblur="calcular_diff2()"> <input type="time" id="tiempo2" onblur="calcular_diff2()">');
    ...
    $('#exampleModal2').on('show.bs.modal', function(event) {
        ...
        document.getElementById('act_cronos').click();
