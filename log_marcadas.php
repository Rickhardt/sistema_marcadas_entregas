    ...
    <div class="container">
        ...
        <form id="FormLog" class="form-signin block-centered" method="POST">
            ...
            <div class="text-center">
                ...
                <!-- <img src="img/hdays.png" class="rounded" width="900px" height="400px" title='AVX INDUSTRIES Ltd.'> -->
            </div>
            <div><b class="text-white"> Ver 4.2.3 Release: 02/09/2021</b> </div>
            <input class="btn-info" type="button" name="acercade" id="acercade" class="btn-info" value="Acerca de..." />
...
<script type="text/javascript">
    ...
    $('#acercade').click(function() {
        Swal.fire({
            icon: 'info',
            title: 'Contacto a Ext 481 :',
            html: '<small><p><b>Ver 4.0.0 (01/10/2020): </b> Version estable </p><p><p><b>Ver 4.1.1 (08/12/2020):</b> Modulo Horas Extras (falta aprobacion desactivadas) </p><p> <b>Ver 4.2.1 (29/12/2020): </b>Capacidad de cancelar Acciones/ajustes erroneos </p><p> <b>Ver 4.2.2 (07/01/2021): </b>Limite en fecha de consulta no puede ser mayor que actual</p><p> <b>Ver 4.2.3 (09/02/2021): </b>Se agrego Ordenamiento por Fecha_reg y fecha inicio en LOGs</p></small>'
        }).then(function() {
            window.location.reload();
